...
set "SOURCE_DIR=C:\ProgramData\aviutl2\Plugin\VW_Media_Input"
set "OUTPUT_DIR=%~dp0"
set "ZIP_NAME=VW_Media_Input.zip"
set "ZIP_PATH=%OUTPUT_DIR%%ZIP_NAME%"
set "TEMP_ROOT=%TEMP%\VW_Media_Input_release_zip"
set "TEMP_DIR=%TEMP_ROOT%\VW_Media_Input"
